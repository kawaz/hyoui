...
| 症状 | 対処 |
|---|---|
| `hyoui list` に session が出ない | `$XDG_RUNTIME_DIR/hyoui` / `${XDG_CACHE_HOME:-$HOME/.cache}/hyoui` の socket dir に stale socket が残っていないか確認 (`docs/runbooks/2026-05-27-stale-socket-detection.md`) |
