...
| 2026-07-03 | bug | open | [bug-flaky-serve-tail-follow-tail-end](./2026-07-03-bug-flaky-serve-tail-follow-tail-end.md) | serve_tail_follow_receives_tail_end_on_child_exit の flaky — 増悪要因として lib suite 32s を特定・除去 (CI 実測 32s:4/8 失敗 vs 4.3s:0/6) したが、**除去後も contention で再現するため未解決** |
