...
|---|---|---|---|---|
| 2026-07-25 | bug | open | [flaky-serve-ro-lock-acquire-rejected](./2026-07-25-bug-flaky-serve-ro-lock-acquire-rejected.md) | `serve_ro_client_lock_acquire_rejected` が suite 高負荷時 (= 32s 回) に SessionExitNotify(143) を拾って落ちる。32s の正体は `/bin/sleep 30` を待つ token test |
