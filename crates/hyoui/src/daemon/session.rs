...
use crate::protocol::messages::{
    ErrorCode, ErrorMessage, LeaderNotify, ModeChange, SessionMode, TailData, TailEnd,
    TailEndReason, TailRequest, WaitMatchOptions, WaitOutcome, WaitPredicate, WaitRequest,
    WaitResult,
};
use crate::protocol::{
    ControlMessage, Frame, HandshakeResponse, MVP_CAPS, TYPE_CBOR_CONTROL, Transport,
    UnixStreamTransport, intersect_caps,
};
...
use super::broadcast::{
    ClientHandle, MAX_CLIENTS_PER_DAEMON, Subscription, broadcast_control, broadcast_master_bytes,
    instant_to_epoch_ms, send_control, writer_pump,
};
...
mod tests {
    ...
    use super::super::lock::generate_lock_token;
    use super::*;
    use crate::protocol::HandshakeRequest;
    use crate::protocol::TYPE_RAW_DATA;
    use crate::protocol::messages::{Detach, DetachTarget, Kill, LockResult};
    use std::io::Write;
