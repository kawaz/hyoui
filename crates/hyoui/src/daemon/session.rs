...
use crate::protocol::messages::{
    ErrorCode, ErrorMessage, LeaderNotify, ModeChange, TailData, TailEnd, TailEndReason,
    TailRequest, WaitMatchOptions, WaitOutcome, WaitPredicate, WaitRequest, WaitResult,
};
...
mod tests {
    ...
    use super::*;
    use crate::protocol::messages::{Detach, DetachTarget, Kill, LockResult, SessionMode};
    use crate::protocol::{
